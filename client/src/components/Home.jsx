    ...
    {newArrivals.length === 0 ? (
      ...
      <div className="flex gap-6 overflow-x-auto scrollbar-hide">
        {newArrivals.map((product) => (
          ...
          <div ref={productSectionRef} className="container mt-28 mx-auto my-8 px-4">
            <h3 className="text-2xl font-bold text-center font-serif text-gray-800 mb-4">Our Products</h3>
